...
from food.models import Nutrition  # Replace 'food' with the actual app name
            ...
            for row in reader:
                try:
                    Nutrition.objects.create(
                        ...
                        vitamin_B12=row['Vitamin B-12'] or None,
                        vitamin_B12_added=row['Vitamin B-12, added'] or None,
                        vitamin_B6=row['Vitamin B-6'] or None,
